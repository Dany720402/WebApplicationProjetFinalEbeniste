        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingCarItems_Meubles_MeubleID",
                        column: x => x.MeubleID,
                        principalTable: "Meubles",
                        principalColumn: "MeubleID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrdersItems_Meubles_MeubleID",
                        column: x => x.MeubleID,
                        principalTable: "Meubles",
                        principalColumn: "MeubleID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCarItems_MeubleID",
